package com.bensnape.examples.highlight;
...
public class Stories extends JUnitStories {
  ...
  public Stories() {
    ...
    Format[] formats = new Format[] {
        new SeleniumContextOutput(seleniumContext), CONSOLE, XML,
        WEB_DRIVER_HTML };
    ...
    ApplicationContext context = new SpringApplicationContextFactory(
        "initialise.xml").createApplicationContext();
  ...
  protected List<String> storyPaths() {
    return new StoryFinder().findPaths(codeLocationFromClass(this.getClass())
        .getFile(), asList("**/" + System.getProperty("storyFilter", "*")
        + ".story"), null);
  }
